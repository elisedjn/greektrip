...
boat.addEventListener("click", (event) => {
  ...
  popUpText.innerHTML = `
  <p class="story"> 6h00 du matin, Athènes. Les yeux encore un peu collés, nous partons de l’hôtel pour prendre le métro. Direction le port où le ferry nous attend. Le bateau est grand, avec différents salons. On choisi les canapés les plus confortables, à l’avant du bateau. Il faut qu’on soit bien, la traversée dure plus de 7 heures! Finalement ça passe assez vite, quelques boissons au bar, un burger immonde au seul snack du bateau,  un film, du repos et nous voilà au port de Santorini, petite esplanade en bas d’une falaise impressionnante. Les habitations sont tout en haut, au bout d’une route sinueuse que nous parcourons en bus.</p>
  <div class="popup-image"><img src="" alt = "Vue de la mer" /> </div>
  `
})
...
donkey.addEventListener("click", (event) => {
 ...
 cat.addEventListener("click", (event) => {
  ...
  <div class="popup-image"><img src="" alt = "Elise à Oia" /> </div>
  `
})
...
cat2.addEventListener("click", (event) => {
  ...
  <div class="popup-image"><img src="" alt = "Steffel à Fira" /> </div>
  `
})
...
sun.addEventListener("click", (event) => {
  popUp.style.display = "block"
  popUpText.innerHTML = `
  <div class="popup-image"><img src="" alt = "Sunset" /> </div>
  `
})
...
plant.addEventListener("click", (event) => {
  ...
  <div class="popup-image"><img src="" alt = "Elise petite" /> </div>
  `
})

plant2.addEventListener("click", (event) => {
  popUp.style.display = "block";
})
...
selfie.addEventListener("click", (event) => {
  ...
  <div class="popup-image"><img src="" alt = "Selfie à Oia" /> </div>
  `
})
...
walking.addEventListener("click", (event) => {
  ...
  <div class="popup-image"><img src="" alt = "Marche" /> </div>
  `
})
...
walking2.addEventListener("click", () => {
  ...
  <div class="popup-image"><img src="" alt = "Fira by night" /> </div>
  `
})
...
fish.addEventListener("click", (event) => {
  ...
  <div class="popup-image"><img src="" alt = "Fira" /> </div>
  `
})
...
seagull2.addEventListener("click", (event) => {
  popUp.style.display = "block";
  popUpText.innerHTML = `
  <div class="popup-image"><img src="" alt = "Ca vente!" /> </div>
  `
})
...
gyros.addEventListener("click", (event) => {
  popUp.style.display = "block";
  popUpText.innerHTML = `
  <p class="story">Aaaaah les gyros! La nouvelle passion de Stef! Ça ressemble aux kebabs que l’on a en France, mais avec de la viande de porc ou de poulet, du tzatziki (crème et concombre) et dans du pain pita (plus moelleux que les pains en France). C’est pas cher, et c’est très bon! Bon, bien sûr on aime aussi la moussaka! </p>
  `
})
